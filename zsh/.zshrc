...
# Zoxide
export PATH="/home/zepten/.local/bin:$PATH"
...
# exa
# alias l='exa --icons --color=always --group-directories-first -lah'
# alias ll='exa --icons --color=always --group-directories-first -lh'
